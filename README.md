...
[`Adsorption isotherm and error map plots`](Adsorption%20isotherm%20and%20error%20map%20plots) folder: After Active learning is complete, these plots can be used to visualize the adsorption isotherm and error heat map for the final GP fits. All the data files are provided for visualization.
