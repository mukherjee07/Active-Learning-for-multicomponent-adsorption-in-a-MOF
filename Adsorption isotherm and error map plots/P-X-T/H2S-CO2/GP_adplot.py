...
plt.title("Adsorption isotherm at $X_{H_{2}S}$ = XXX, Temp = YYY K",fontsize = "36")
plt.grid(visible=True,which='minor',color='#999999',linestyle='-',alpha=0.2)
#plt.ylabel("$CO_2$ adsorption in molecules/cylinder vol.($\AA^3$)", fontsize = "20")
plt.ylabel("$H_{2}S$ and $CO_2$ uptake in mg/g", fontsize = "36")
...
#plt.xscale('log')
plt.ylim(0,1000)
plt.savefig('AL_limit_Adsorption_H2S_XXX_YYY.png',dpi=300)
plt.show()
