...
ax.invert_yaxis()
ax.set_xlabel('Mole fraction $X_{H_{2}S}$ $\Longrightarrow$',size='44',rotation=0)
plt.text(56.00,12.5,'Relative Error (in %)  $\Longrightarrow$', rotation=90,fontsize='44')
plt.savefig('H2S_RQ.png',dpi=300)
#df1 = pd.read_csv('error.csv',delimiter=',')
...
ax.invert_yaxis()
ax.set_ylabel('Pressure (in bar) $\Longrightarrow$',size='44')
ax.set_xlabel('Mole fraction $X_{CO_2}$  $\Longrightarrow$',size='44',rotation=0)
plt.text(56.00,12.5,'Relative Error (in %)  $\Longrightarrow$', rotation=90,fontsize='44')
plt.savefig('CO2_RQ.png',dpi=300)
