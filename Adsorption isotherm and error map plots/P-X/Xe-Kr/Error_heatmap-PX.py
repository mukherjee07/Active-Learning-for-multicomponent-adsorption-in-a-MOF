...
ax.invert_yaxis()
ax.set_xlabel('Mole fraction $X_{Xe}$ $\Longrightarrow$',size='44',rotation=0)
plt.text(56.00,12.5,'Relative Error (in %)  $\Longrightarrow$', rotation=90,fontsize='44')
plt.savefig('Xe_RQ.png',dpi=300)
#df1 = pd.read_csv('error.csv',delimiter=',')
...
ax.invert_yaxis()
ax.set_ylabel('Pressure (in bar) $\Longrightarrow$',size='44')
ax.set_xlabel('Mole fraction $X_{Kr}$  $\Longrightarrow$',size='44',rotation=0)
plt.text(56.00,12.5,'Relative Error (in %)  $\Longrightarrow$', rotation=90,fontsize='44')
plt.savefig('Kr_RQ.png',dpi=300)
