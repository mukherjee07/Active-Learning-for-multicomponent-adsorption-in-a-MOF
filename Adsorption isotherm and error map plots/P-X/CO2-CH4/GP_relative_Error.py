...
os.system("rm error.csv")
os.system("touch error.csv")
os.system("echo 'Pressure,mole_fraction,Error_h2s,Error_co2' >> error.csv")
...
for i in range(X1_size):
	...
	for j in range(P_size):
		...
		e1 = ((GP_co2[j,i] - y1_g[Loc])/(y1_g[Loc] + 1E-3))*100
		e2 = ((GP_ch4[j,i] - y2_g[Loc])/(y2_g[Loc] + 1E-3))*100
		os.system("echo "+str(P)+","+str(mol)+","+str(e1)+","+str(e2)+" >> error.csv")
		os.system("sed -i 's/[][]//' error.csv")
		os.system("sed -i 's/[][]//' error.csv")
		os.system("sed -i 's/[][]//' error.csv")
		os.system("sed -i 's/[][]//' error.csv")
		os.system("sed -i 's/[][]//' error.csv")
