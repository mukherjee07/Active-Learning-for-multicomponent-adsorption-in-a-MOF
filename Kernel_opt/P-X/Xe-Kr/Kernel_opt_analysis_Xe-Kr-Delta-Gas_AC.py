...
df = pd.read_csv('Kernel_250_PTX.csv',delimiter=',')
...
plt.rc('xtick',labelsize=28)
host.set_ylabel("AL Performance in P-X",fontsize="34",color="black")
...
color2 = "green"
color3 = "blue"
p1, = host.plot(Iter, PERFORMANCE, markeredgecolor='k',linestyle='-.',marker='D',markersize='20',label=r"Performance = $\frac{{\overline{100-AC_{Xe}}}+{\overline{100-AC_{Kr}}}+{\overline{AC_{CL}}}+{\overline{MRE_{Xe}}}+{\overline{MRE_{Kr}}}}{5}$",color="silver",linewidth=5)
p11, = host.plot(Iter, Delco2_90,markeredgecolor='k', marker='*',linestyle=':',markersize='12',label=r"${\overline{100-AC_{Xe}}}$",color="cyan",linewidth=5)
p12, = host.plot(Iter, Delch4_90,markeredgecolor='k', marker='H',linestyle='-.',markersize='12',label=r"${\overline{100-AC_{Kr}}}$",color="turquoise",linewidth=5)
...
p2, = par1.plot(Iter, mre_co2, markeredgecolor='k',linestyle='-',marker='o',markersize='12',label=r"${\overline{MRE}}$ for $Xe$",color="lightgreen",linewidth=3)
#p22, = par1.plot(Iter, A_ch4[:I], linestyle=':',marker='o',label="MRE for $CH_4$ in %",color="cyan")
p3, = par2.plot(Iter, mre_ch4,linestyle=':',markeredgecolor='k', marker='o',markersize='12',label=r"${\overline{MRE}}$ for $Kr$",color="salmon",linewidth=3)
...
major_ticks = np.arange(0, Iter[LEN-1], 1)
...
host.legend(lines, [l.get_label() for l in lines],fontsize="34", bbox_to_anchor=(1.13,1) )
