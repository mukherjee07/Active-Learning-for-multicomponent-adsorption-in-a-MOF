...
color2 = "green"
color3 = "blue"
p1, = host.plot(Iter, PERFORMANCE, markeredgecolor='k',linestyle='-.',marker='D',markersize='20',label=r"Performance = $\frac{{\overline{100-AC_{CO_2}}}+{\overline{100-AC_{CH_4}}}+{\overline{AC_{CL}}}+{\overline{MRE_{CO_2}}}+{\overline{MRE_{CH_4}}}}{5}$",color="silver",linewidth=5)
p11, = host.plot(Iter, Delco2_90,markeredgecolor='k', marker='*',linestyle=':',markersize='12',label=r"${\overline{100-AC_{CO_2}}}$",color="cyan",linewidth=5)
p12, = host.plot(Iter, Delch4_90,markeredgecolor='k', marker='H',linestyle='-.',markersize='12',label=r"${\overline{100-AC_{CH_4}}}$",color="turquoise",linewidth=5)
...
p2, = par1.plot(Iter, mre_ch4, markeredgecolor='k',linestyle='-',marker='o',markersize='12',label=r"${\overline{MRE}}$ for $CH_4$",color="lightgreen",linewidth=3)
#p22, = par1.plot(Iter, A_ch4[:I], linestyle=':',marker='o',label="MRE for $CH_4$ in %",color="cyan")
p3, = par2.plot(Iter, mre_co2,linestyle=':',markeredgecolor='k', marker='o',markersize='12',label=r"${\overline{MRE}}$ for $CO_2$",color="salmon",linewidth=3)
...
host.grid(which='minor', alpha=0.5,linestyle=':')
host.grid(which='major', alpha=1.0,linestyle='--')
